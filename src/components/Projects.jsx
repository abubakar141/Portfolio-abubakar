...
const projects = [
  ...
  { name: 'Olx Clone', description: 'OLX clone Using Next.js To Improve My Coding And Become Next.js Developer' },
  ...
  { name: 'Code Studio', description: 'I have using HTML CSS to make a Code Studio'},
